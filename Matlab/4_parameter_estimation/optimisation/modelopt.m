function [xdot] = modelopt(x, u,theta)
...
%Script: Model of the carousel used for simulation and lineal control
...
wn=6.2409;                  %rad/s  
d=0.1288;                   %[.]
mu_alpha = theta(2);          %N*m*s/rad
mu_beta = theta(3);           %N*m*s/rad
mu_air=theta(1);              %kg/m
i_t=theta(4);                 %kg*m^2
