...
h1=plot(t-21.9-120,u,'Color',[0.6,0,0.8],'lineWidth',1.3);
...
hold on;
grid on;
load('azimuth_lost.mat')
plot(T(1:end - 1), Xref(3, :), 'k')
plot(t-21.9-delay, betaEst(1:length(t)), 'g','lineWidth',2.5)
plot(T, X(3, :), 'b','lineWidth',1.3)
plot(t-21.9-delay-40, azimuth(1:length(t)),'r','lineWidth',1.25)
xlabel('Time [s]')
ylabel('Azimuth [rad]')
