function [xdot] = model_lin_cont13(x, u)
...
%Comments: This model has a changed tethet length from 1.5 m to 1.3 m for
%the purpose of a robust analysis against tether length variations of the
...
m_ball = 0.57;              %kg
l_t = 1.3;                  %m TETHET LENGTH IS CHANGED TO 1.3 M
