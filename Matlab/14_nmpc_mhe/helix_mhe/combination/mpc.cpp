...
void mexFunction( int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[] ) 
 { 
    ...
    acadodata_f1 << ddelta_arm;
    acadodata_f1 << alpha;
    acadodata_f1 << beta;
    acadodata_f1 << dddelta_arm;
    acadodata_f1 << dalpha;
    acadodata_f1 << dbeta;
    acadodata_f1 << ddelta_motor_sp;
    acadodata_f1 << sqrt((2.000000E+00*2.050000E+00*cos(alpha)*cos(beta)*l_tether+4.202500E+00+pow(cos(alpha),2.000000E+00)*pow(l_tether,2.000000E+00)));
    acadodata_f1 << l_tether*sin(alpha);
    acadodata_f1 << dddelta_motor_sp;
    ...
    acadodata_f2 << l_tether*sin(alpha);
    OCP ocp1(0, 0.8, 40);
    ...
    acadodata_f3 << dot(ddelta_motor_sp) == dddelta_motor_sp;
